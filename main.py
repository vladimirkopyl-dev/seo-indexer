# 1. Features Section
    ...
    # 2. FAQ Section
    faq_list = [
        ("What is a URL and what can be indexed?", "A URL must start with http:// or https:// and lead to an accessible page. You can index blog posts, backlinks, social profiles, and public listings."),
